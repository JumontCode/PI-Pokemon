...
const findAllTypes = require('./controllers/typeControllers/findAllTypes.js');
const createType = require('./controllers/typeControllers/createType.js');
...
server.post("/pokemon", async (req, res) => {
  try {
    const { name, image, life, stroke, defense, speed, height, weight } =
      req.body;
